...
- `generate_round2_analysis.py`: `ae9456c32c32004c94a15449855e8746c7198042c9260162ea60d78026bbbd8f`
...
129 timed workload repetitions completed; timeout and incomplete rows, if any, remain visible in `scaling_runs.csv`.
The partitioned `n=300`, `H=52`, `K=4`, `B=50` cell had 5 timeout repetitions and 0 completed repetitions; its median is therefore missing and the timeout is annotated in the scaling figure.
